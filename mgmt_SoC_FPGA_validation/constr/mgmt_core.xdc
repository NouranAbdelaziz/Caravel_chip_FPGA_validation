...
create_clock -add -name core_clk -period 83.333 -waveform {0 41.666} [get_ports {core_clk}];
...
#set_input_delay 5.0000 -clock [get_clocks {core_clk}] -add_delay [get_ports {sram_ro_addr[*]}];
...
## 12 MHz Clock Signal
set_property PACKAGE_PIN L17 [get_ports {core_clk}]; #IO_L12P_T1_MRCC_14 Sch=gclk
set_property IOSTANDARD LVCMOS33 [get_ports {core_clk}]; #IO_L12P_T1_MRCC_14 Sch=gclk
